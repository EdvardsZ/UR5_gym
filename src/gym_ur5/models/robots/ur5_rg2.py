...
class UR5RG2(model_wrapper.ModelWrapper, model_with_file.ModelWithFile):
    def __init__(
        ...
        # output_string = scenario_gazebo.urdffile_to_sdfstring("/home/robo/penvs/env1/lib/python3.8/site-packages/gym_ignition_models/ur5_rg2/ur5_rg2.urdf")
        # print("scenario_gazebo.urdffile_to_sdfstring: ", output_string)


        # printable_model = model.to_gazebo().joint_names()
        # print("model.to_gazebo().joint_names(): ", printable_model)

        # Set initial joint configuration
        # robot_joints_for_reset = [name for name in model.joint_names() if name not in ["rg2_finger_joint1", "rg2_finger_joint2"]]
        # print("robot_joints_for_reset: ", robot_joints_for_reset)
        ...
        # pid_gains_1000hz = {
        #     "shoulder_pan_joint": scenario.PID(500, 0, 50),
        #     "shoulder_lift_joint": scenario.PID(500, 100, 30),
        #     "elbow_joint": scenario.PID(10000, 0, 50),
        #     "wrist_1_joint": scenario.PID(200, 10, 20),
        #     "wrist_2_joint": scenario.PID(100, 0, 10),
        #     "wrist_3_joint": scenario.PID(100, 0, 10),
        #     "rg2_finger_joint1": scenario.PID(100, 0, 50),
        #     "rg2_finger_joint2": scenario.PID(100, 0, 50),
